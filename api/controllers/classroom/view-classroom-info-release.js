  ...
  fn: async function (input) {
    ...
    if (input.classromId) {
      ...
      if(!classrooms.classroomqrcodeurl){
        ...
        var qrcodecreateobj = await axios.post('https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token=' + wxtokent.data.access_token, { "expire_seconds": 1800, "action_name": "QR_LIMIT_SCENE", "action_info": { "scene": { "scene_str": "classroomid:" + input.classromId } } });
