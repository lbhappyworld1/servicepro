  ...
  fn: async function (input) {
    ...
    if (input.classromId) {
      ...
      if(!classrooms.classroomqrcodeurl ||input.isrefresh=="Y"){
        ...
        var qrcodecreateobj = await axios.post('https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token=' + wxtokent.data.access_token, { "action_name": "QR_LIMIT_SCENE", "action_info": { "scene": { "scene_str":input.classromId } } });
